...
import com.example.androidmicroapps.features.imc.composables.CounterSelector
import com.example.androidmicroapps.features.imc.composables.GenderSelector
import com.example.androidmicroapps.features.imc.composables.HeightSelector
...
fun ImcScreen(onResultSelected: (Float) -> Unit, onBackSelected: () -> Unit) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(title = {Text("IMC Calculator")},
        ...
        Column (Modifier.padding(paddingValues).fillMaxSize()){
            GenderSelector(
                ...
                onGenderSelected =  {isMaleSelected = it}
            )
